...
t1 = Theme.create(name: "Star Wars", words: "Force, Jedi, Troopers, lightsaber, Naboo, X-win, Leia, Skywalker, Chewbacca, R2-D2, Greedo, Darklighter, Stormtrooper, Kylo, Force, Jedi, Qui-gon, Empire, Republic, Eisley, Space, Corellian, Spaceship, Father, Lucas, Saga, Clones, Droids, Galaxies, Resistance, Snoke, Lando")
t2 = Theme.create(name: "Runtime Terror", words: "Blake, Caleb, Cornelius, Georgii, Gian, Placido, Raul, Jeannie, Somaia, Stephen, Steven, Vidhi, Mitchell, Paul, Vien, Kahoot, Lectures, Whiteboard, Ego-less, Teamwork, Challenges, Programming, Discussions, Labs, learn.co, Flatiron, WeWork, Houston")
t3 = Theme.create(name: "The Office", words: "Bears, Beets, Chili, Jim, Dwight, Angela, Meredith, Stanley, Paper, Beesly, Halpert, Kevin, Andy, Creed, Kelly, Holly, Creed, Sales, Sabre, Pyramid, Scranton, Jello, Astrid, Chrysller, WUPHF.com, Dunder Mifflin, Parkour, Netflix, Legumes")
